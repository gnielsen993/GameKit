...
struct SolitaireGameView: View {
    ...
    // MARK: - Drag gesture + coordinate helpers
    //
    // tableauDragGesture, the three drop-finalizers, and the column/card
    // coordinate helpers live in SolitaireGameView+DragGesture.swift.
