...
| Current milestone | `v1.6` release candidate — Be Kind + Math Crossword; build 4 uploaded to App Store Connect; processing; status in `Docs/releases/v1.6-upload.md`; absorbed the never-released 1.5.1 | 2026-09-10 |
