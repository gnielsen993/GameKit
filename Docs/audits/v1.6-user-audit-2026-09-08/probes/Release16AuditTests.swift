...
@MainActor
final class Release16AuditTests: XCTestCase {
    ...
    func testDeepWordGridFollowHintAndFinish() {
        ...
        let tiles = app.staticTexts.matching(NSPredicate(format: "label BEGINSWITH 'Letter '")).allElementsBoundByIndex
    ...
    func testSmallSudokuAndBackgroundTimer() {
        ...
        XCTExpectFailure("Hint timer resumes when returning from the background") {
